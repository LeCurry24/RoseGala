const gallerySelect = () => {
    return (
      <div className="relative group rounded-lg w-56 mb-5 mt-5 bg-neutral-950 overflow-hidden before:absolute before:w-12 before:h-12 before:content[''] before:right-0 before:bg-blue-400 before:rounded-full before:blur-lg ">
        <svg
          y="0"
